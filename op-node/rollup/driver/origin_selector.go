...
func (los *L1OriginSelector) FindL1Origin(ctx context.Context, l2Head eth.L2BlockRef) (eth.L1BlockRef, error) {
	...
	msd := los.spec.MaxSequencerDrift(currentOrigin.Time) // TODO: 兼容性？？
	...
	pastSeqDrift := l2Head.Time+los.cfg.BlockTime > currentOrigin.Time+msd // TODO: 兼容性
	...
	if l2Head.Time+los.cfg.BlockTime >= nextOrigin.Time && (pastSeqDrift || receiptsCached) { // TODO: 兼容性
